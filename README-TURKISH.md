...
───────────────────────────────────────────────────────────────────────
        ...
        Taskhivc serbest çalışan kullanıcılar için mobil ve masaüstü 
        bir uygulamadır. Yanlış anlaşılmaları ve sorumlulukleri en 
        aza indirgemek için iş yükünü görevlere ayrılır.

        Taskhivc pazarı, herhangi bir hizmeti alıp satmak ve istediğiniz 
        herhangi bir ödeme yöntemiyle dünyadaki herhangi bir yerden ödemenizi 
        sağlar.

        İTİBAR AĞI
        ───────────────────────────────────────────────────────────────

        Taskhivc, çevrimiçi hizmetler için yapılan ödemelerin yaradılıştan 
        riskli olduğu varsayımıyla oluşturulmuştur - bu yüzden Taskhivc 
        şeffaf bir itibar ağını kullanmaktadır. Bu şekilde, ne kadar güven 
        vermek istediğinizi kontrol edebilirsiniz.

        Taskhivc'in görev temelli ödeme modeli dolandırıcılık karlılığını 
        sınırlar ve yanlış anlaşılmaları azaltırken aynı zamanda kullanıcıların 
        itibarlarını daha hızlı geliştirmelerine yardımcı olur.
